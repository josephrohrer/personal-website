			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<h1 class="section-heading">PORTFOLIO</h1><br>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 col-sm-6 portfolio-item">
						<a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
							...
							<img src="images/portfolio/abquery.png" class="img-responsive" alt="">
						</a>
				...
				<div class="row">
					...
					<div class="row">
						<form id="contactForm" action="php/mailer.php" method="post">
							...
							<div class="col-md-6">
								<div class="form-group">
								<textarea class="form-control" placeholder="Your Message *" id="message" name="message" rows="6"
											 required
